...
module.exports = {
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "33624184758",  // Owner's WhatsApp number
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "bot musique",           // Owner's name
    DEV: process.env.DEV || "33624184758",                     // Developer's contact number
    DEVELOPER_NUMBER: '33624184758@s.whatsapp.net',            // Developer's WhatsApp ID
    ...
    DESCRIPTION: process.env.DESCRIPTION || "*© bot musique*",  // Bot description
